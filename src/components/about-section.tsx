...
export function AboutSection() {
  ...
  const skills = {
    [translate('about.skills.backend') as string]: ['.NET Core', 'ASP.NET', 'C#', 'Web API', 'Entity Framework'],
    [translate('about.skills.frontend') as string]: ['React', 'Angular', 'TypeScript', 'JavaScript', 'HTML5', 'CSS3'],
    [translate('about.skills.databases') as string]: ['SQL Server', 'PostgreSQL', 'MongoDB'],
    [translate('about.skills.principles') as string]: ['SOLID', 'Clean Architecture', 'DDD', 'Microservicios'],
  ...
  return (
    <section id="sobre-mi" className="w-full py-16 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col-reverse lg:flex-row gap-12 lg:items-start">
          <div className="lg:w-2/3 space-y-8">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold font-headline tracking-tighter sm:text-4xl text-primary">{translate('about.title') as string}</h2>
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold font-headline text-primary">{translate('about.certifications.title') as string}</h3>
              <div className="space-y-4">
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-bold font-headline tracking-tighter sm:text-3xl text-center text-primary mb-8">{translate('about.favoriteTools') as string}</h3>
